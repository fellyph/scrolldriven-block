...
- **CSS scroll timeline browser support**: Check [Can I Use](https://caniuse.com/?search=scroll-timeline) for current compatibility
- **wp-scripts build**: Compiles JSX, minifies CSS, generates `build/index.asset.php` with dependencies
